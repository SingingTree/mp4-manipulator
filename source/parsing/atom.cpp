...
std::optional<uint64_t> AtomOrDescriptorBase::GetPositionInStream() const {
  return position_in_stream_;
}

void AtomOrDescriptorBase::SetPositionInStream(uint64_t position_in_file) {
  position_in_stream_ = position_in_file;
}
